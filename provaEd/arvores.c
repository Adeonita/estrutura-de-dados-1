...
//**************************************************
//                Fun̵̤es para Percorrer a Arvore
//**************************************************
...
//    Impresṣo 2D
//********************************************************************
// fun̤̣o que prepara a chamada da fun̤̣o print2Util
void print2D(Arvore *raiz)
{
    print2DUtil(raiz, 0);
}
// Fun̤̣o para imprimir a arvore em 2d
...
void print2DUtil(Arvore *raiz, int espaco)
{
    ...
    // Imprime o nodo depois do espa̤o
    printf("\n");
